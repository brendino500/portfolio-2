        ...
        <div className={classes.textContent}>
          ...
          <Grid maxWidth="md">
            <Typography className={classes.text}>
              ...
              (yes, that is a thing!), I have always been creative. Paired with
              my recent completion of the Software Engineering bootcamp I hope
              to continue my learning and bring my creativity into the
              workplace.
            </Typography>
            <br />
